...
<html>
    ...
    -->
        ...
        <button type="button" class="btn btn-info btn-lg " data-toggle="modal" data-target="#modal_proveedor" onclick="limpiar()">Nuevo Proveedor</button>
        ...
        <div class="modal-body">
            ...
            <form action="sr_proveedor" method="post" class="form-group">
                ...
                <label for="lbl_idEmpleado"><b>Id Proveedores:</b></label>
                 ...
                 <input type="text" name="txt_nit" id="txt_nit"class="form-control" placeholder="Ejemplo: 000000" required>
                 <label for="lbl_direccion"><b>Direccion:</b></label>
                 <input type="text" name="txt_direccion" id="txt_direccion"class="form-control" placeholder="Ejemplo: 1ra ave" required>
